  ...
  return (
    <div className="overflow-hidden rounded-xl border border-ink-200 bg-white shadow-card dark:border-ink-800 dark:bg-ink-900">
      <table className="w-full text-left text-sm">
        <thead>
          <tr className="border-b border-ink-200 bg-ink-50 text-2xs uppercase tracking-wider text-ink-500 dark:border-ink-800 dark:bg-ink-950/50 dark:text-ink-400">
            ...
            return (
              <>
                <tr
                  ...
                  className="cursor-pointer transition-colors hover:bg-blush-50/60 dark:hover:bg-ink-800/50"
                >
                  ...
                  <td className="px-5 py-3.5 text-right tabular-nums text-ink-700 dark:text-ink-300">
                    {lead.eventCount}
                  </td>
                  <td className="px-5 py-3.5 text-ink-600 dark:text-ink-400">
                ...
                {isOpen ? (
                  <tr key={`${lead.id}-detail`} className="bg-ink-50/70 dark:bg-ink-950/40">
                    <td colSpan={6} className="px-5 py-4">
                      <p className="mb-3 text-2xs font-medium uppercase tracking-wider text-ink-500 dark:text-ink-400">
                        Recent activity
                      </p>
                          ...
                          {lead.recentEvents.map((event) => (
                            <li key={event.id} className="flex items-baseline gap-3 text-sm">
                              <span className="w-2 flex-none">
                                <span className="block h-1.5 w-1.5 rounded-full bg-blush-500" />
                              </span>
                              ...
                              <span className="ml-auto flex-none text-xs tabular-nums text-ink-500 dark:text-ink-400">
